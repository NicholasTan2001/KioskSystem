        ...
        case "add":
            if (!empty($_POST["quantity"])) {
                ...
                if ($requestedQuantity > $menuDetails["remainingQuantity"]) {
                    header("Location: RUserMenuOrder.php?error=Quantity exceeds available stock");
                    exit();
                }
...
<div class="box"><br><br>
    <div id="shopping-cart">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px; text-align:right;">
                                <form method="post" action="RUserMenuOrder.php?action=update&menuID=<?php echo $item["code"]; ?>">
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px; text-align:center;">
                                <button onclick="location.href='RUserMenuOrder.php?action=remove&menuID=<?php echo $item["code"]; ?>'" class="btnRemove">Remove</button>
                            </td>
                            </tr>
                        <?php
        ...
        <br>
        <button id="btnEmpty" onclick="location.href='RUserMenuOrder.php?action=empty'">Empty Cart</button>

        <button onclick="location.href='RUserConfirmOrder.php'" class="btnConfirmOrder">Confirm Order</button>
        <br>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px;">
                                <form method="post" action="RUserMenuOrder.php?action=add&menuID=<?php echo $product_array[$key]["menuID"]; ?>">

...
Module 1: Edit Food Vendor Details
-->
<?php
session_start();
...
if (mysqli_num_rows($result) > 0){
  ...
  $foodVandorEmail= $row["foodVendorEmail"];
...
<form class="userProfile-box" id="EditUserDetails" method="post" action="UpdateFoodVendorDetails.php">

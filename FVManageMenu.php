...
Module 2: Manage Menu (Food Vendor)
-->
<?php
session_start();
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="FVUpdateMenu.php?dailyMenuID=<?php echo $dailyMenuID; ?>&menuName=<?php echo $menuName; ?>&menuPrice=<?php echo $menuPrice; ?>" class="btn btn-primary">UPDATE</a>

...
Module 1: Food Vendor (User Profile)
-->
...
<?php
   ...
   if (mysqli_num_rows($result) > 0){
       ...
       $foodVendorImage= $row["foodVendorImage"];
        ...
        if($userName==$username){
          ...
          $age = $foodVendorAge;
          $email = $foodVendorEmail;
          $image = $foodVendorImage;
...
<form class="userProfile-box" id="userImage" method="post" enctype="multipart/form-data">
        ...
        <button class="button-28" type="submit" onclick="updateProfile()">UPDATE</button>

        <br><br>
        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo $username . " is " . $age . " years old. " . " Email address is " . $email . ". Nice to meet you! " ?>" width="100" height="100">
...
function updateImage() {
      document.getElementById('userImage').action = 'UpdateFVImage.php';
